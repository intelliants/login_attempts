...
if (isset($_SESSION['password_entry_period']) &&
    $_SESSION['password_entry_period'] < date(iaDb::DATETIME_FORMAT) && $_SERVER['REQUEST_URI'] == '/login/') {
...
if ($login) {
    ...
    if ($member) {
        ...
        if ($userBlocked && $userBlocked['password_entry_period'] != null
            && $userBlocked['password_entry_period'] < date(iaDb::DATETIME_FORMAT)) {
